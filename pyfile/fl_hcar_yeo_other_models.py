...
class Arguments():
    def __init__(self):
        ...
        self.model_name = '../model/offical/resnet50-19c8e357.pth'
...
def ResNet_s(args):
    ...
    if args.flag:
        ...
        pretrain_model = resnet50(pretrained=False)
        ...
        pretrain_model = resnet50(pretrained=False, num_classes=5).to(device)
...
def VGG_s(args):
    ...
    if args.flag:
        ...
        pretrain_model = vgg16_bn(pretrained=False, num_classes=5).to(device)
        params_conv = pretrain_model.parameters()
    # pretrain_model = resnet18(pretrained=False, num_classes=5)
    return pretrain_model, params_conv
