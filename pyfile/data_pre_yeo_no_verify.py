...
Train_Dir = '../data2/train_yeo/'
Test_Dir = '../data2/test_yeo/'
# Verify_Dir = '../data2/verify_yeo/'
...
DATA_DIR_224 = '../data2/train_yeo_224/'
DATA_DIR2_224 = '../data2/test_yeo_224/'
# DATA_DIR3_224 = '../data/verify_yeo_224/'
